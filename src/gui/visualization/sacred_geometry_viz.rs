    ...
    pub fn from_spiral_pattern(
        ...
        for i in 0..num_points {
            ...
            let radius = if matches!(
                spiral.spiral_type(),
                crate::sacred_geometry::SpiralType::Golden
            ) {
    ...
    pub fn from_vesica_piscis(
        ...
        for point in vesica.intersection_points() {
            intersection_points.push(IntersectionPoint {
                position: [point.0 as f32 * scale, point.1 as f32 * scale, 0.0],
...
impl FlowerOfLifeRenderData {
    pub fn from_flower_of_life(
        ...
        let center = [
            flower.center().0 as f32 * scale,
            flower.center().1 as f32 * scale,
            0.0,
        ];
...
impl StandingWaveRenderData {
    pub fn from_standing_wave(
        ...
        let interference_color = match wave.interference_type {
            crate::sacred_geometry::InterferenceType::Constructive => {
                colors.standing_wave_constructive
            }
            crate::sacred_geometry::InterferenceType::Partial => colors.standing_wave_partial,
            crate::sacred_geometry::InterferenceType::Destructive => {
                colors.standing_wave_destructive
            }
        };
        ...
        for node_pos in &wave.nodes {
            nodes.push([(*node_pos - 0.5) as f32 * 2.0 * scale, 0.0, 0.0]);
        }
...
impl SacredGeometryVisualization {
    ...
    pub fn add_fibonacci(&mut self, sequence: &FibonacciSequence) {
        self.fibonacci = Some(FibonacciRenderData::from_sequence(
            sequence,
            &self.colors,
            self.global_scale,
        ));
    ...
    pub fn add_spiral(&mut self, spiral: &SpiralPattern, num_points: usize) {
        self.spirals.push(SpiralRenderData::from_spiral_pattern(
            spiral,
            &self.colors,
            num_points,
        ));
    ...
    pub fn add_platonic_solid(&mut self, structure: &PlatonicStructure) {
        self.platonic_solids
            .push(PlatonicSolidRenderData::from_structure(
                structure,
                &self.colors,
                self.global_scale,
            ));
    ...
    pub fn add_vesica_piscis(&mut self, vesica: &VesicaPiscis) {
        self.vesica_piscis
            .push(VesicaPiscisRenderData::from_vesica_piscis(
                vesica,
                &self.colors,
                self.global_scale,
            ));
    ...
    pub fn add_flower_of_life(&mut self, flower: &FlowerOfLife) {
        self.flower_of_life
            .push(FlowerOfLifeRenderData::from_flower_of_life(
                flower,
                &self.colors,
                self.global_scale,
            ));
    ...
    pub fn add_harmonic_resonance(
        &mut self,
        resonance: &FrequencyResonance,
        harmonic_series: &HarmonicSeries,
    ) {
        self.harmonic_resonance
            .push(HarmonicResonanceRenderData::from_resonance(
                resonance,
                harmonic_series,
                &self.colors,
                self.global_scale,
    ...
    pub fn add_standing_wave(&mut self, wave: &StandingWave, num_points: usize) {
        self.standing_waves
            .push(StandingWaveRenderData::from_standing_wave(
                wave,
                &self.colors,
                num_points,
                self.global_scale,
...
mod tests {
    ...
    fn test_fibonacci_render_data() {
        ...
        let render_data =
            FibonacciRenderData::from_sequence(&sequence, &SacredGeometryColors::default(), 1.0);
        assert_eq!(render_data.max_generation, 11);
        assert_eq!(render_data.points.len(), 11);
        assert_eq!(render_data.connections.len(), 10);
    }
    ...
    fn test_spiral_render_data() {
        ...
        let render_data =
            SpiralRenderData::from_spiral_pattern(&spiral, &SacredGeometryColors::default(), 100);
    ...
    fn test_platonic_solid_render_data() {
        ...
        let render_data =
            PlatonicSolidRenderData::from_structure(&solid, &SacredGeometryColors::default(), 1.0);
    ...
    fn test_vesica_piscis_render_data() {
        ...
        let render_data = VesicaPiscisRenderData::from_vesica_piscis(
            &vesica,
            &SacredGeometryColors::default(),
            1.0,
        );
    ...
    fn test_flower_of_life_render_data() {
        ...
        let render_data = FlowerOfLifeRenderData::from_flower_of_life(
            &flower,
            &SacredGeometryColors::default(),
            1.0,
        );
    ...
    fn test_harmonic_resonance_render_data() {
        ...
        let render_data = HarmonicResonanceRenderData::from_resonance(
            &resonance,
            &series,
            &SacredGeometryColors::default(),
            1.0,
    ...
    fn test_standing_wave_render_data() {
        ...
        let render_data = StandingWaveRenderData::from_standing_wave(
            &wave,
            &SacredGeometryColors::default(),
            100,
            1.0,
