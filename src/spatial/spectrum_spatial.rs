...
impl SpectrumSpatialDynamics {
    ...
    pub fn derive_position_from_spectrum(
        ...
        let gradient =
            self.compute_coherence_gradient(entity_id, spectrum_position, &field_coherence_fn);
        ...
        let derived_position =
            CoherenceDerivedPosition::new(position, spectrum_position, coherence, gradient);
    ...
    pub fn update_statistics(&mut self) {
        ...
        for pos in self.positions.values() {
            ...
            let grad_mag = (pos.coherence_gradient[0].powi(2)
                ...
                + pos.coherence_gradient[2].powi(2))
            .sqrt();
        ...
        self.statistics.coherence_gradient_magnitude =
            total_gradient_mag / self.positions.len() as f64;
    }
